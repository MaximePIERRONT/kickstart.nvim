...
do
  ...
  -- [[ Colorscheme ]]
  -- Catppuccin Latte (thème clair). Autres flavours : frappe, macchiato, mocha.
  -- Voir :Telescope colorscheme pour lister les schémas installés.
  -- `name = 'catppuccin'` est requis car le dépôt GitHub s'appelle `nvim`.
  vim.pack.add { { src = gh 'catppuccin/nvim', name = 'catppuccin' } }
  require('catppuccin').setup {
    flavour = 'latte',
    styles = {
      comments = {}, -- pas d'italique sur les commentaires
    },
  }
