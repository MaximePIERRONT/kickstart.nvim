...
local expected_maps = {
  ...
  { '<leader>gm', 'merge request picker' },
  { '<leader>gr', 'review current branch' },
  { '<leader>gC', 'close merge request review' },
  { '<leader>ld', 'lazydocker' },
  { '<leader>lD', 'lazydocker fullscreen' },
  { '<leader>ls', 'lazysql' },
  -- Herdr
  { '<leader>Ht', 'herdr tab' },
}
...
local commands = {
  ...
  'LazySQL',
  'LazyGitFullscreen',
  'LazyDockerFullscreen',
  'MergeRequest',
  'MergeRequestReview',
  'MergeRequestClose',
  'HerdrTab',
  'KickstartEnsureTools',
  'AlternateTest',
}
