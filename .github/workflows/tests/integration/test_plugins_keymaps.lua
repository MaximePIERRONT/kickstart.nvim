...
local expected_maps = {
  ...
  { '<F3>', 'dap step out' },
  { '<F7>', 'dapui toggle' },
  -- P2 LazyGit / LazyDocker / Rainfrog
  { '<leader>gg', 'lazygit' },
...
local commands = { 'Npm', 'Maven', 'Micronaut', 'RunConfig', 'MavenTest', 'Neotree', 'Telescope', 'LazyGit', 'LazyDocker', 'Rainfrog', 'KickstartEnsureTools' }
